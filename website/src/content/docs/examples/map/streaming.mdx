...
on **Canvas** it re-projects paths, same as retained. The demo below streams **100k** translucent
polygon ranges via the pass-through path — raise "Data size" to push the ceiling further.
