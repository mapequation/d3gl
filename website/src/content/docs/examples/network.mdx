...
(declutter, `sizeMode`, the on-screen-bounded per-frame work) is unchanged. The map register's
distinctive **flow-border** nodes and **bent half-arrow** links land in the next steps.
