...
small badge follows the cursor showing **+** (add) or **−** (subtract). While you drag, the glyphs the box
currently covers light up with the **hover ring** (a live preview of what's in the box). No extra call: it's
