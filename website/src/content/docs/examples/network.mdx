...
Wiring these onto **module super-edges** — so a map's inter-module links read as bent half-arrows
weighted by flow — is the next step, together with an interactive map-of-networks example.
