...
const controls: ControlSpec[] = [
  ...
  { type: "select", key: "size", label: "Data size", options: DATA_SIZES, value: "10M" },
...
/** Streaming random world points via the pass-through path — uncapped, flat GPU memory. */
export default function StreamingPassthrough() {
  return (
