...
export interface PlotProps {
  ...
  zoom?: [number, number];
  /** Fires after each user pan/zoom with the current view transform (k, x, y) — not for the initial
   *  view when `zoom` is enabled, and not for a programmatic `setTransform`. */
