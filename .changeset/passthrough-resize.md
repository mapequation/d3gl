...
surface is now re-created at the new size and refilled in the same single repaint as before.
The Canvas backend was already correct and is now covered by the same tests.
